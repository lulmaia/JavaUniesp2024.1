...
public class NewJFrame extends javax.swing.JFrame {
 ...
 public void addTable(String Name, Double Price){
        ...
        String Qty = JOptionPane.showInputDialog("Digite a Quantiade");
 ...
 public void bill_print(){
        ...
        try {
            bill.setText("                         Laricas' Pizza \n");
            bill.setText(bill.getText() + "\tRua do Sabor,123 \n");
            bill.setText(bill.getText() + "\tJoão Pessoa, Paraíba \n");
            bill.setText(bill.getText() + "\t+55 83 4002-8922 \n");
            bill.setText(bill.getText() + "----------------------------------------------------------------\n");
            bill.setText(bill.getText() + " Item \tQtd \tPreço \n");
            bill.setText(bill.getText() + "----------------------------------------------------------------\n");
            ...
            bill.setText(bill.getText() + "Pago :\t"+Cash.getText()+"\n");
            bill.setText(bill.getText() + "Valor :\t"+Bal.getText()+"\n");
            bill.setText(bill.getText() + "====================================\n");
            bill.setText(bill.getText() +"                     OBRIGADO VOLTE SEMPRE...!"+"\n");
            bill.setText(bill.getText() + "----------------------------------------------------------------\n");
            bill.setText(bill.getText() +"                     DEUS É FIEL"+"\n");
